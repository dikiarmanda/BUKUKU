    ...
    <div class="row mt-5 g-0">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <div class="row align-content-center">
                <div class="col-6">
                    <a href="../pages/addMember.php" class="btn btn-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="hapus.php?idMember=<?= $row["idMember"] ?>" class="btn btn-danger ms-1" onclick="return confirm('Apakah Anda yakin menghapus member ini ?')">
